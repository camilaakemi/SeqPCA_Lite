...
pI Filter: Discards sequences with an Isoelectric Point above a defined threshold (e.g., 5.5). This is particularly useful for avoiding enzymes that would immobilize by adsorbing to negatively charged clay particles in soil environments.
